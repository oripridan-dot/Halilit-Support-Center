...
class NordProcessor:
    def normalize(self, raw_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        blueprint = {
            ...
            # Inference fallback
            "main_category": raw_payload.get('hierarchy', {}).get('category', 'Keys'),
            ...
            # Accept both PDFs and HTML documentation
            "manual_urls": raw_payload.get('manual_urls') or raw_payload.get('manuals', []),
