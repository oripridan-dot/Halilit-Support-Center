...
//    Style: rounded corners, bg-zinc-700, aspect-square

// b. Product Title Skeleton
//    Style: bg-zinc-700, h-6, rounded-md, w-3/4

// c. Product Brand Skeleton
//    Style: bg-zinc-700, h-4, rounded-md, w-1/2

// d. Product Price Skeleton
// Style: bg-zinc-700, h-4, rounded-md, w-1/3

// Add margin to the top of 1, 2 to add spacing for all elements.
```
