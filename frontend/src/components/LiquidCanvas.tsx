...
/** Defines the structure of the Liquid Canvas schema. */
...
/** Defines the structure of the Liquid data response. */
...
function MetricCardWidget({
  data,
  columns,
}: MetricCardWidgetProps): JSX.Element {
...
/**
 * The main LiquidCanvas component that fetches data and renders the appropriate widget.
 */
