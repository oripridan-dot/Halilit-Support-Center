# Changelog - Halilit Support Center
...
- **Automatic Context Logging** (`backend/agents/auto_context.py`)
  - Zero manual logging
  - Decorator-based automation
  - Perfect CopilotKit sync
...
- **Autonomous Execution**
  - Auto-fix with 85%+ confidence
  - Backup creation
  - Post-execution validation

- **Memory API Endpoints**
  - `GET /api/memory/stats/{agent_name}`
  - `GET /api/memory/advice/{agent_name}`
...
- **Trinity Swarm Agents**
  ...
  - OfficialVerifier - Spec enrichment
  - ExternalValidator - Quality auditing

- **CopilotKit Integration**
  - Real-time agent communication
  - UI-driven agent commands
  - Streaming responses
...
- **Patch** (5.2.x): Bug fixes, small improvements

## Links

- [README.md](README.md) - Quick start
- [ADK_ARCHITECTURE.md](ADK_ARCHITECTURE.md) - System architecture
- [AGENT_LEARNING.md](AGENT_LEARNING.md) - Learning system
